...
const title2 = document.querySelector("#title"); //id 선택자
console.log(title2);
...
const students = [
  { name: "HJ", age: 17, address: "Kirkland WA" },
  { name: "EW", age: 17, address: "Busan Haeundae" },
  { name: "JW", age: 19, address: "Changwon Jinhae" },
];
